...
public class VendingMachineDaoFileImplTest {
    ...
    public void setUp() throws Exception {
        ...
        //add to hashmap
        items.put(1, firstItem);
        items.put(2, secondItem);
        ...
        for (Item currentItem : itemList) {
            ...
            itemAsText = currentItem.getItemNum() + "::" + currentItem.getItemName() + "::"
                    + currentItem.getItemCost() + "::" + currentItem.getInventoryNum();
